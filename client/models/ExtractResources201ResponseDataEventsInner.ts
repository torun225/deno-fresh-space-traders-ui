...
export class ExtractResources201ResponseDataEventsInner {
    'symbol': ExtractResources201ResponseDataEventsInnerSymbolEnum;
    'component': ExtractResources201ResponseDataEventsInnerComponentEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "symbol",
            "baseName": "symbol",
            "type": "ExtractResources201ResponseDataEventsInnerSymbolEnum",
            "format": ""
        },
        {
            "name": "component",
            "baseName": "component",
            "type": "ExtractResources201ResponseDataEventsInnerComponentEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return ExtractResources201ResponseDataEventsInner.attributeTypeMap;
    }
...
export enum ExtractResources201ResponseDataEventsInnerSymbolEnum {
...
export enum ExtractResources201ResponseDataEventsInnerComponentEnum {
    Frame = 'FRAME',
    Reactor = 'REACTOR',
    Engine = 'ENGINE'
}
